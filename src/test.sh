...
/usr/libexec/PlistBuddy -c "Print $uglymodel" /System/Library/PrivateFrameworks/ServerInformation.framework/Versions/A/Resources/English.lproj/SIMachineAttributes.plist |awk '/marketingModel/{ sub(/^.*= /, ""); print; }' 
